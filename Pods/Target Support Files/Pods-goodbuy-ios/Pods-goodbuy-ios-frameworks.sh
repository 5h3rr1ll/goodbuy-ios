...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_dsym "${PODS_ROOT}/ScanditBarcodeCapture/ScanditBarcodeCapture.framework.dSYM"
  install_framework "${PODS_ROOT}/ScanditCaptureCore/ScanditCaptureCore.framework"
  install_dsym "${PODS_ROOT}/ScanditCaptureCore/ScanditCaptureCore.framework.dSYM"
fi
